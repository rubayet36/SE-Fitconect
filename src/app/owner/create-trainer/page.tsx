    ...
    <div className="p-4 lg:p-8 max-w-xl mx-auto space-y-5">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <h1 className="text-2xl lg:text-3xl font-black text-white mt-1">Add Trainer</h1>
        </div>
      </div>

      <p className="text-zinc-500 text-sm">
        Create a new trainer account. They will be able to log in immediately and start managing members.
      </p>

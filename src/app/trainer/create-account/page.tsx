  ...
  return (
    <div className="p-4 lg:p-8 max-w-xl mx-auto space-y-5">
      <div className="flex items-center gap-4">
        <Link href="/trainer/dashboard" className="p-2 bg-zinc-900 border border-zinc-800 rounded-lg text-zinc-400 hover:text-white hover:border-zinc-600 transition-all">
          <ArrowLeft size={16} />
        </Link>
        <div>
          <p className="text-zinc-500 text-xs tracking-widest uppercase font-semibold">Admin</p>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          >
            {loading ? (
              ...
              <><UserPlus size={16} /> Create Trainer</>
            )}
          </button>
        </form>
      </div>
